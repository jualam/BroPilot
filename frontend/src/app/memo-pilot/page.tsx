...
const recorderSteps = ["Context Intake", "Memo Planner", "Risk Checker", "Human Review"];
      ...
      <section className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-xl leading-8 text-zinc-600">
            Company notes to review-ready memo drafts.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-[0.9fr_1fr_1.1fr]">
          <DemoPanel title="Input">
            <p className="text-sm leading-6 text-[#d0d6e0]">
              Company: ExampleCo
              <br />
              Sector: AI workflow automation for healthcare clinics
              <br />
              Notes: ARR growth, retention, GTM motion, implementation risks.
            </p>
          </DemoPanel>
          ...
          <DemoPanel title="Output">
            <ul className="grid gap-3 text-sm leading-6 text-[#d0d6e0]">
              <li>Company overview and market thesis</li>
              <li>Growth signals and review flags</li>
              <li>Diligence questions and missing evidence</li>
              <li>Partner-ready reviewer notes</li>
            </ul>
          </DemoPanel>
        </div>
